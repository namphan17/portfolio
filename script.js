...
//  $('#my-fixed-nav').toggleClass('scrolled', $(this).scrollTop() > 700);
// });
  ...
  $(window).scroll(function() {
      ...
      if(scroll > position) {
          ...
          if (scroll < screenHeight-50) {
            ...
            $('.header-container .brand-container').css("display", "block");
